      ...
      <div class="row">
        <div class="col-lg-12">
          <div class="card fieldwork-card">
            <img src="assets/img/company-logo.png" alt="Company Logo" class="logo">
            <i class="bi bi-pencil-square edit-icon" title="Edit"></i>
            <div class="card-body">
              <h5 class="card-title">Company Name: Lueilwitz, Wisoky and Leuschke</h5>
              <h6 class="card-subtitle mb-2 text-muted">Fieldwork Title: Assistant Web Designer</h6>
              <p class="card-text">Fieldwork Description: Sunt est soluta temporibus accusantium neque nam maiores cumque temporibus. Tempora libero non est unde veniam est qui dolor. Ut sunt iure rerum quae quisquam autem eveniet perspiciatis odit. Fuga sequi sed ea saepe at unde.</p>
