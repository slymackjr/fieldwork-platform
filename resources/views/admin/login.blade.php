                ...
                <div class="col-lg-9 col-md-12 col-sm-12 col-12 infinity-form mx-auto">
                    ...
                    <form class="px-3" method="POST" action="{{ route('login-employer') }}">
                        ...
                        <div class="form-input mb-3">
                            ...
                            <input type="email" name="supervisorEmail" placeholder="Email Address" class="form-control" required>
                        </div>
                        <div class="form-input mb-3">
                            <span><i class="fa fa-lock"></i></span>
                            <input type="password" name="supervisorPassword" placeholder="Password" class="form-control" required>
                        </div>
                        <!-- Login Button -->
