                                ...
                                <div class="single_jobs white-bg d-flex justify-content-between">
                                    <div class="jobs_left d-flex align-items-center">
                                        ...
                                        <div class="jobs_conetent">
                                            <a href="{{route('job-details')}}"><h4>Software Engineer</h4></a>
                                    ...
                                    <div class="jobs_right">
                                        <div class="apply_now">
                                            ...
                                            <a href="{{route('job-details')}}" class="boxed-btn3">Apply Now</a>
                                        </div>
                                        <div class="date">
                            ...
                            <div class="col-lg-12 col-md-12">
                                <div class="single_jobs white-bg d-flex justify-content-between">
                                    <div class="jobs_left d-flex align-items-center">
                                        ...
                                        <div class="jobs_conetent">
                                            <a href="{{route('job-details')}}"><h4>Digital Marketer</h4></a>
                                            <div class="links_locat d-flex align-items-center">
                                                <div class="location">
                                                    <p> <i class="fa fa-map-marker"></i> California, USA</p>
                                                </div>
                            ...
                            <div class="col-lg-12 col-md-12">
                                <div class="single_jobs white-bg d-flex justify-content-between">
                                    <div class="jobs_left d-flex align-items-center">
                                        ...
                                        <div class="jobs_conetent">
                                            <a href="{{route('job-details')}}"><h4>Wordpress Developer</h4></a>
                                            <div class="links_locat d-flex align-items-center">
                                                <div class="location">
                                                    <p> <i class="fa fa-map-marker"></i> California, USA</p>
                                                </div>
                            ...
                            <div class="col-lg-12 col-md-12">
                                <div class="single_jobs white-bg d-flex justify-content-between">
                                    <div class="jobs_left d-flex align-items-center">
                                        ...
                                        <div class="jobs_conetent">
                                            <a href="{{route('job-details')}}"><h4>Visual Designer</h4></a>
                            ...
                            <div class="col-lg-12 col-md-12">
                                <div class="single_jobs white-bg d-flex justify-content-between">
                                    <div class="jobs_left d-flex align-items-center">
                                        ...
                                        <div class="jobs_conetent">
                                            <a href="{{route('job-details')}}"><h4>Creative Designer</h4></a>
                                            <div class="links_locat d-flex align-items-center">
                                                <div class="location">
                                                    <p> <i class="fa fa-map-marker"></i> California, USA</p>
                                                </div>
