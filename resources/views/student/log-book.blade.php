...
<body>
 ...
 <body>
                   ...
                   <div class="row">
                    <div class="col-md-12">
                      ...
                      <select class="form-select" id="selectedDay">
                        ...
                        <!-- For demonstration purposes, let's assume 40 days -->
                        <!-- You can dynamically generate options for actual 40 days -->
                        <!-- Example options for demonstration -->
                        <option value="1">Day 1</option>
                        <option value="2">Day 2</option>
                        <!-- Repeat for all 40 days -->
                      </select>
                      <!-- Add a button to submit the selected day -->
                      <button type="submit" class="btn btn-primary mt-3">Submit Day</button>
                    </div>
                  </div>
                </form>
              </div>
          ...
          <div class="col-lg-6">
            <div class="card">
              <div class="card-body log-book-container">
                ...
                <!-- Create a single textarea for the selected day's log -->
                <div class="mb-3 log-book-day">
                  <!-- Display the selected day here -->
                  ...
                  <!-- Add a button to submit the log for the selected day -->
  ...
  <script>
    document.addEventListener('DOMContentLoaded', function() {
      // Function to handle form submission for selecting a day
      document.getElementById('logBookForm').addEventListener('submit', function(event) {
        event.preventDefault();
      ...
      // Function to handle form submission for submitting the log for the selected day
      document.getElementById('dayLogForm').addEventListener('submit', function(event) {
        event.preventDefault();
        const log = document.getElementById('dayLog').value;
        // Here you can handle the submission of the log for the selected day, such as saving it to a database
        console.log('Log for the selected day:', log);
        // You can replace the console.log with actual code to handle form submission
      });
    });
  </script>
